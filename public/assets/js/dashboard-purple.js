(function($) {
  ...
  $(function() {
    if ($("#performaneLinePurple").length) { 
      const ctx = document.getElementById('performaneLinePurple');
    ...
    if ($("#status-summary-purple").length) { 
      const statusSummaryChartCanvas = document.getElementById('status-summary-purple');
    ...
    if ($("#marketingOverviewPurple").length) { 
      const marketingOverviewCanvas = document.getElementById('marketingOverviewPurple');
    ...
    if ($("#leaveReportPurple").length) { 
      const leaveReportCanvas = document.getElementById('leaveReportPurple');
